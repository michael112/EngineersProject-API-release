...
public class MessageController {
    ...
    public ResponseEntity<? extends AbstractResponseJson> sendUserMessage(@PathVariable("id") String userID) {
    ...
    public ResponseEntity<? extends AbstractResponseJson> sendGroupMessage(@PathVariable("id") String groupID) {
        throw new org.apache.commons.lang3.NotImplementedException("");
    }
