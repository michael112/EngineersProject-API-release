    ...
    public void testGetCreatingCourseData() throws Exception {
        ...
        this.mockMvc.perform(get(this.testedClassURI + '/' + AdminCourseControllerUrlConstants.AVAILABLE_CREATING_COURSE_DATA)
            ...
            .andExpect(content().contentType("application/json;charset=utf-8"))
                ...
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(0).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(0).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(0).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(1).getId() + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(1).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(1).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(1).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(1).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(1).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(2).getId(    ) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(2).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(2).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(2).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(2).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(2).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(3).getId() + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(3).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(3).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(3).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(3).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(3).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(4).getId() + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(4).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(4).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(4).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(4).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(4).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(5).getId() + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(5).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(5).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(5).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(5).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(5).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(6).getId() + "\")]").exists())
                .andExpect(jsonPath("$.languages.languages[?(@.languageID == \"" + this.testEnvironment.getLanguages().get(6).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(6).getLanguageName("EN") + "\" && @.hasCourses == " + this.testEnvironment.getLanguages().get(6).hasActiveCourses() + " )].languageNames[?(@.namedLanguageID == \"" + this.testEnvironment.getLanguages().get(6).getId() + "\" && @.namingLanguageID == \"" + this.testEnvironment.getLanguages().get(0).getId() + "\" && @.languageName == \"" + this.testEnvironment.getLanguages().get(6).getLanguageName(this.testEnvironment.getLanguages().get(0).getId()) + "\")]").exists())
