...
public class LoginControllerTest extends AbstractControllerTest {
    ...
    public void setMockito() {
        reset(userCrudServiceMock, labelProviderMock, domainURIProviderMock, tokenProviderMock);
    ...
    public void testLoginSuccess() throws Exception {
        ...
        when( this.userCrudServiceMock.findUserByUsername(Mockito.any(String.class)) ).thenReturn(sampleUser);
        ...
        verify(this.userCrudServiceMock, times(1)).findUserByUsername(Mockito.any(String.class));
    }
