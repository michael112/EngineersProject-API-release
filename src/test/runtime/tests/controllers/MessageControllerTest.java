...
public class MessageControllerTest extends AbstractControllerTest {
    ...
    public void testGetUserReceivedMessages() throws Exception {
        ...
        this.mockMvc.perform(get(URL)
            ...
            .andExpect(jsonPath("$.messages.messages[?( @.title == \"" + sampleMessage1.getTitle() + "\" && @.content == \"" + sampleMessage1.getContent() + "\"  && @.course.courseID == \"" + sampleMessage1.getCourse().getId() + "\" && @.course.language.id == \"" + sampleMessage1.getCourse().getLanguage().getId() + "\" && @.course.language.name == \"" + sampleMessage1.getCourse().getLanguage().getLanguageName("en") + "\" && @.course.courseLevel.courseLevelID == \"" + sampleMessage1.getCourse().getCourseLevel().getId() + "\" && @.course.courseLevel.name == \"" + sampleMessage1.getCourse().getCourseLevel().getName() + "\" && @.course.courseType.courseTypeID == \"" + sampleMessage1.getCourse().getCourseType().getId() + "\" && @.course.courseType.name == \"" + sampleMessage1.getCourse().getCourseType().getCourseTypeName("en") + "\" && @.announcement == " + sampleMessage1.isAnnouncement() + ")]").exists())
    ...
    public void testGetUserSendedMessages() throws Exception {
        ...
        this.mockMvc.perform(get(URL)
            ...
            .andExpect(jsonPath("$.messages.messages[?( @.sender.userID == \"" + sampleMessage1.getSender().getId() + "\" && @.sender.name == \"" + sampleMessage1.getSender().getFullName() + "\" && @.title == \"" + sampleMessage1.getTitle() + "\" && @.content == \"" + sampleMessage1.getContent() + "\"  && @.course.courseID == \"" + sampleMessage1.getCourse().getId() + "\" && @.course.language.id == \"" + sampleMessage1.getCourse().getLanguage().getId() + "\" && @.course.language.name == \"" + sampleMessage1.getCourse().getLanguage().getLanguageName("en") + "\" && @.course.courseLevel.courseLevelID == \"" + sampleMessage1.getCourse().getCourseLevel().getId() + "\" && @.course.courseLevel.name == \"" + sampleMessage1.getCourse().getCourseLevel().getName() + "\" && @.course.courseType.courseTypeID == \"" + sampleMessage1.getCourse().getCourseType().getId() + "\" && @.course.courseType.name == \"" + sampleMessage1.getCourse().getCourseType().getCourseTypeName("en") + "\" && @.announcement == "+ sampleMessage1.isAnnouncement() + " )]").exists())
            .andExpect(jsonPath("$.message", is(returnMessage)))
            .andExpect(jsonPath("$.success", is(true)));
    }
