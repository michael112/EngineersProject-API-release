...
public class GradeControllerTest extends AbstractControllerTest {
    ...
    public void testGetGradeListTeacher() throws Exception {
        ...
        this.mockMvc.perform(get(URL)
            ...
            .andExpect(jsonPath("$.grades.course.courseLevel.courseLevelID", is(sampleCourse.getCourseLevel().getId())))
            .andExpect(jsonPath("$.grades.course.courseLevel.name", is(sampleCourse.getCourseLevel().getName())))
