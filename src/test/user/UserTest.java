...
public class UserTest extends AbstractTest {
    ...
    public void testUserSet() {
        Set<User> users = this.userService.findAllUsers();
    ...
    public void testGetUser() {
        User sampleUserDb = this.userService.findUserByID(this.sampleUser.getId());
    ...
    public void testDeleteUser() {
        this.userService.deleteUser(this.sampleUser);

        Assert.assertNull(this.userService.findUserByID(this.sampleUser.getId()));
    }
    ...
    public void testUpdateUsername() {
        ...
        this.userService.updateUser(this.sampleUser);

        User userDb = this.userService.findUserByID(this.sampleUser.getId());
    ...
    public void testUpdateAddUserRole() {
        UserRole admin = this.userRoleService.findUserRoleByRoleName("ADMIN");
    ...
    public void testUpdateRemoveUserRole() {
        ...
        User userDbBefore = this.userService.findUserByID(this.sampleUser.getId());
        userDbBefore.removeUserRole(admin);
        this.userService.updateUser(userDbBefore);

        User userDbAfter = this.userService.findUserByID(this.sampleUser.getId());
